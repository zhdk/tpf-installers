...
#script
echo -e "\033[1;32m The script 'tpf-video-runner.command' executes and supports the following steps:\033[0m"
...
#echo -e "\033[1;32m Choose a codec by writing the respective code (e.g. H.264): H.264\033[0m"    
while true; do
...
echo -e "\033[1;33m Choose your port by writing the appropriate number  \033[0m"
while true; do
...
echo -e "\033[1;31m [1/6] What is the address of your remote partner? \033[0m"
