...
echo -e "\033[1;31m'tpf-audio-runner.command' executes and supports the following steps: \033[0m"
echo -e "\033[1;32m [1/1] Opening the Digital Audio Workstation ‘Ardour6’ from ‘Applications' \033[0m"
echo -e "\033[1;32m [1/2] Opening the ‘TPF-Client’ from the folder ‘tpf-tools’.\033[0m"
echo -e "\033[1;32m [1/3] Proposing a selection of preconfigured Ardour sessions from the folder 'ardour-templates’.\033[0m" 
echo -e "\033[1;32m [1/4] Selecting the connection and audio parameters in the TPF-Client.\033[0m" 
echo -e "\033[1;32m [1/5] Making a connection with the remote peers.\033[0m" 
echo -e "\033[1;32m [1/6] Closing the connection and the session.\033[0m" 
echo "------------------------------------------------------------"
while true; do
...
echo "Ardour opens with an ‘empty_setup’ template from the folder ‘ardour-templates’."
echo -e "\033[1;33m When Ardour is open, go to the ‘Audio/MIDI Setup’ window from the menu ‘Window’. \033[0m"
...
echo -e "\033[1;33m Go to the TPF-Client and click on ‘Settings’. A window opens.\033[0m"
...
echo -e "\033[1;33mYou can now close the ‘Settings’ window.\033[0m"
echo -e "\033[1;33m The next time you open a session, the TPF-Client \033[0m"
echo -e "\033[1;33m will automatically open the settings last saved.\033[0m"
while true; do
    read -p "Do you wish to continue [y/n] " answer
    [[ $answer == "y" || $answer == "Y" || $answer == "" ]] && break
    [[ $answer == "n" || $answer == "N" ]] && exit 0
...
echo -e "\033[1;32m at the left-hand side of your name. It turns blue.\033[0m"
...
echo -e "\033[1;32m The box turns blue. \033[0m"
...
echo -e "\033[1;33m [1/6] Stop the connection in the TPF-Client by clicking on the upper left blue box. \033[0m"
